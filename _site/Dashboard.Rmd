...
p1 <- ggplot(df3, aes(x=Timestamp, y=`n_distinct(MAC)`)) + geom_point(size=1) + scale_x_datetime(date_breaks = "1 day", date_labels = "%b-%d %H:%M", limits = c(min, max)) + theme(axis.text.x = element_text(angle=45, hjust = 1)) +  scale_y_continuous(limits=c(0,50)) + labs(title = "Frequency over Time")
...
p2 <- ggplot(df3, aes(x=Timestamp, y=`n_distinct(MAC)`)) + geom_point(size=1) + scale_x_datetime(date_breaks = "1 hour", date_labels = "%b-%d %H:%M", limits = c(lastday, max)) + theme(axis.text.x = element_text(angle=45, hjust = 1)) +  scale_y_continuous(limits=c(0,40)) + labs(title = "Frequency over 1 Day")
...
```{r}
p3 <- ggplot(df3, aes(x=Timestamp, y=`n_distinct(MAC)`)) + geom_histogram(stat="identity") + scale_x_datetime(date_breaks = "5 min", date_labels = "%b-%d %H:%M", limits = c(lasthour, max)) + theme(axis.text.x = element_text(angle=45, hjust = 1)) + labs(title = "Frequency over last hour")

p4 <- ggplot(df3, aes(x=Timestamp, y=`n_distinct(MAC)`))  + geom_point(size = 0.3, alpha=0.25) + scale_x_datetime(date_breaks = "12 hour", date_labels = "%b-%d %H:%M", limits = c(lastweek, max)) + theme(axis.text.x = element_text(angle=45, hjust = 1))  + labs(title = "Frequency over last week") +  scale_y_continuous(limits=c(0,40)) + geom_ma(ma_fun = SMA, n = 30, color = "red", size = 1)
...
p5 <- ggplot(df7, aes(x=time, y=median)) + geom_histogram(stat="identity") + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + labs(title = "Median of MAC over Time 00:00 AM to 11:59 PM")

p6 <- ggplot(df8, aes(x=time, y=mean)) + geom_histogram(stat="identity") + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + labs(title = "Mean of MAC over Time 00:00 AM to 11:59 PM")
